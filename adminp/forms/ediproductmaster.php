...
$olgaquery="UPDATE productmaster SET createdip='$myIp',dateceated='$dateceated', companyid='$companyid', category_name='$category_name', product_name='$product_name', product_description='$product_description', bbrand='$bbrand', product_size='$product_size', product_colour='$product_colour', mrp_purchase='$mrp_purchase', mrp_sale='$mrp_sale', in_stock_quantity='$in_stock_quantity', product_image_master='$product_image_master', product_masterid='$product_masterid', primary_product='$primary_product', isnewpromotional='$isnewpromotional', isfeaturedproduct='$isfeaturedproduct', rateing='$rateing', totalvotes='$totalvotes', averagerating='$averagerating' WHERE rowId='$myquerydcs'";
 $myquery=$conn->query($olgaquery); ?>
<!--*Other setup *-->
<? $id = $myquerydcs;?>
<? 
echo "<script>window.location=\"../lisplproductmaster.php?refid=$myquerydcs\";</script>";?>