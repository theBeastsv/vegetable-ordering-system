...
<div class="container">
                           ...
                           <form id="mycartho" action="forms/upkart.php" method="post" enctype="multipart/form-data"><table class="table table-bordered">
							...
							echo $fincart;
								...
								?>
                                  ...
                                  <tfoot>
                            <tr>
                            	<td colspan="5" align="right"><input name="forxmprocess" type="hidden" value="2" /><input name="" class="btn btn-custom btn-sm" type="submit" value="Update Cart"></td>
                            </tr>
                            </tfoot>
                            </tbody>
                        </table>
				...
				<? include("cpages/billingshipping.php");?>
