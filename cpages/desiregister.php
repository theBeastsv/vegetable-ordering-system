<div class="container">
                    <h2 class="mb30">Register Account</h2>
                    <form action="forms/signupduser.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6 ">
                            ...
                            <div class="col-sm-6 ">
                                <div class="form-group">
                                   <label>Mobile Phone</label>
                                    <input name="mobileno" type="text" class="form-control validate[required] text-input" id="mobileno" placeholder="Mobile Phone">
                                </div><!-- End .from-group -->
                            </div><!-- End .col-sm-6 -->
                        </div><!-- End .row -->
