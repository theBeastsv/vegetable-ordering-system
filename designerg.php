...
$sellerBanner=getSellerBanner($desId);


$BcId= show_selecttable($debug,$limitstring,$conn,'seller_master','*','WHERE rowId=\''.$desId.'\'',$limit,1,' rowId ASC');
$maxrita= ' ';
...
<h1><?=$company_name ;?></h1>
<ol class="breadcrumb">  
<li class="active">By <?=$first_name;?> <?=$last_name;?></li>
</ol>
</div><!-- End .container -->
</div><!-- End .page-header -->
<div class="container">
<?
include("cpages/designerg.php");
?>
</div><!-- End .container -->
